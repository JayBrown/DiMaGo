...
**Please note that DiMaGo might not work correctly with macOS 10.12 (Sierra), because Apple seems to have changed the behavior of `security` and the macOS keychains.**
